...
def unsafe_eval(user_input):
    ...
    - Example: If `user_input` is `__import__('os').system('del C:\\')`, it will delete all files in C: drive.
    """
    eval(user_input)  # This will execute whatever Python code is passed as input.
