...
example1_onehot = model.predict([[0, 1, 3400]])
...
example2_onehot = model.predict([[1, 0, 2800]])
print(example2_onehot)  # 2800 sqr ft home in Robbinsville

# Comparison of predictions
print("\nComparison of predictions:")
print("For 3400 sq ft in West Windsor:\nOriginal prediction:", example1, "\nOneHotEncoded prediction:", example1_onehot)
print("\nFor 2800 sq ft in Robbinsville:\nOriginal prediction:", example2, "\nOneHotEncoded prediction:", example2_onehot)
